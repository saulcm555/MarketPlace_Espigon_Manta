...
router.get("/:id", getClientByIdValidation, validateRequest, authMiddleware, roleMiddleware("client"), ownershipMiddleware("client"), getClientById); // Solo el cliente dueño o admin
router.post("/", createClientValidation, validateRequest, createClient); // Público para registro
router.put("/:id", getClientByIdValidation, updateClientValidation, validateRequest, authMiddleware, roleMiddleware("client"), ownershipMiddleware("client"), updateClient); // Solo el cliente dueño o admin
